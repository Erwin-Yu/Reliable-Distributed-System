...
public class backupServer {
    ...
    public static int activeBackupServerNum;
    ...
    public backupServer(ServerSocket newServer, String my_state, int activeBackupServerNum) {
        this.newServer = newServer; 
        this.my_state = my_state;
        this.timer = new Timer();
        this.resetTimer = new Timer();
        this.count = new AtomicInteger(0);
        this.activeBackupServerNum = activeBackupServerNum;
